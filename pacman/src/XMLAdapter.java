...
//    reading xml files, and then input to Controller for visualization, loading, saving
    @Override
...
//    convert the xml file to a string maze, from which level check is conducted

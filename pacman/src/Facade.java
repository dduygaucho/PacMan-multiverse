...
//    private
    public Facade(String filePath, boolean auto) throws IOException {
...
//            return XML files only
            File[] listOfFiles = folder.listFiles(new FileFilter() {
                ...
                public boolean accept(File file) {
                    return file.isFile() && Character.isDigit(file.getName().charAt(0))
...
//                        run the game, open a new window if win the previous one
                        Game game = new Game(gameCallback, file, mainDict, auto);
